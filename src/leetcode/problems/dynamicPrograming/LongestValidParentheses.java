...
//        System.out.println(valid.longestValidParentheses5(s));
//        System.out.println(valid.longestValidParentheses3(s));
        System.out.println(valid.longestValidParentheses6(s));
    ...
    public int longestValidParentheses5(String s) {
        ...
        for (int i = 0; i < n; i++) {
            if(s.charAt(i)==')') {
                if(sin==-1 || s.charAt(sin)==')') {
                    sin=i;
                    continue;
                }
                sin=pos[sin];
                max=Math.max(max, i-sin);
            }else {
                pos[i]=sin;
                sin=i;
            }
    ...
    public int longestValidParentheses2(String s) {
        ...
        int max=0, stacksize=0, j=-1;
        while (++j<s.length()){
            if(s.charAt(j)=='(') {
                stacksize++;
                if(top[stacksize]==null)
                    top[stacksize] = j;
            } else {
                if(stacksize==0){
                    top[stacksize+1]=null;
                    continue;
                }
                max=Math.max(max, j-top[stacksize]+1);
                top[stacksize+1]=null;
                stacksize--;
            }
        }
